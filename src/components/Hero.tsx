...
import qaTestingHero from "@/assets/qa-testing-hero.jpg";
...
const Hero = () => {
  ...
  return (
    <section 
      ...
      id="hero" 
      style={{
        background: 'linear-gradient(135deg, #0c4a6e 0%, #075985 25%, #0369a1 50%, #0ea5e9 75%, #38bdf8 100%)',
      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            <div 
              className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-white/20 text-white border border-white/30 mb-3 sm:mb-6 opacity-0 animate-fade-in" 
            ...
            >
              ...
              <span className="text-pulse-200">Software Developer</span>
            </h1>
            ...
            {lottieData ? (
              ...
              <div className="relative transition-all duration-500 ease-out overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl">
                <img 
                  ref={imageRef} 
                  src={qaTestingHero} 
                  alt="QA Testing and Automation Workspace" 
                  className="w-full h-auto object-cover transition-transform duration-500 ease-out" 
                  style={{ transformStyle: 'preserve-3d' }} 
                />
                <div className="absolute inset-0" style={{ backgroundImage: `url(${qaTestingHero})`, backgroundSize: 'cover', backgroundPosition: 'center', mixBlendMode: 'overlay', opacity: 0.3 }}></div>
              </div>
              </>
            )}
          </div>
